      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="shrink-0 mr-4">
            {/* Logo */}
            <Link to="/" className="grid-cols-2 px-4 py-3 flex items-center transition duration-150 ease-in-out" aria-label="Graphiti">
              ...
              <p className='text-center ml-4 pt-1 text-2xl font-bold text-slate-400 transition duration-150 ease-in-out hover:bg-clip-text hover:text-transparent hover:bg-gradient-to-r from-blue-500 to-teal-400'>Graphiti</p>
            </Link>
          </div>
          ...
          <nav className="hidden md:flex md:grow">
            ...
            <ul className="flex grow justify-end flex-wrap items-center">
              <li>
                <Link to="/" className="text-gray-700 hover:text-blue-300 px-4 py-2 flex items-center transition duration-150 ease-in-out">
                  Home
                </Link>
              </li>
              <li>
                <Link to="/about" className="text-gray-700 hover:text-blue-300 px-4 py-2 flex items-center transition duration-150 ease-in-out">
                  About Us
                </Link>
              </li>

              {/* logo icons */}
              <div className='flex grid-cols-2 content-center space-between gap-3'>
                <li>
                ...
                <li>
                  <a href="https://discord.gg/qnTw4cT6kS" target={"_blank"} className="flex justify-center items-center text-purple-600 bg-blue-200 hover:text-gray-100 hover:bg-blue-500 rounded-full transition duration-150 ease-in-out" aria-label="D">
            ...
            {/* <ul className="flex grow justify-end flex-wrap items-center">
              <li>
                <Link to="/signin" className="font-medium text-blue-600 hover:text-gray-200 px-4 py-3 flex items-center transition duration-150 ease-in-out">Sign in</Link>
              </li>
              <li>
                <Link to="/signup" className="btn-sm text-white bg-blue-600 hover:bg-purple-700 ml-3">Sign up</Link>
              </li>
            </ul> */}

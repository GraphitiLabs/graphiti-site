        ...
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto -my-4 md:-my-6" data-aos-id-timeline>
            ...
            <div className="relative py-4 md:py-6 pl-24" data-aos="fade-up" data-aos-anchor="[data-aos-id-timeline]">
              <div className="pl-2">
                <div className="font-mono text-lg text-blue-500 mb-2">The seed</div>
                <div className="flex items-center mb-3">
                  <div className="absolute left-0 inline-flex text-sm font-semibold py-1 px-3 text-gray-600  bg-green-200 rounded-full">2016</div>

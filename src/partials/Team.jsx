      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            ...
            <p className="text-xl text-gray-400">Makers and academics who understand the need for real tangible products built on chain blah blah blah. we are in the vacuum tube stage </p>
          </div>
